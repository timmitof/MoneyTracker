...
class ExpenseAdapter(private val array: List<Expenses>, val context: FragmentActivity): RecyclerView.Adapter<ExpenseAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.title.text = item.nameExpenses
        holder.sum.text = item.sumExpenses.toString()
    }
