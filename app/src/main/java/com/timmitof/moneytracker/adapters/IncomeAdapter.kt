...
class IncomeAdapter(private val array: List<Income>, val context: FragmentActivity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_fab_btn, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.title.text = item.nameIncome
        holder.sum.text = item.sumIncome.toString()
    }
